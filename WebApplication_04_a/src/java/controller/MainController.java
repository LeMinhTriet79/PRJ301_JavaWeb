...
public class MainController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("Uoc so chung lon nhat la:");
            if (txtA == null || txtA.trim().length() == 0) {
                out.println("Vui long nhap vao gia tri a");
                return;
            }
            if (txtB == null || txtB.trim().length() == 0) {
                out.println("Vui long nhap vao gia tri b");
                return;
            }
            int a = 0;
            int b = 0;
            ...
            // output result
            int result = GCD(a, b);
            out.println("Greatest Common Divitor ("+a+","+b+")" + "="+ result);
        }
    }
