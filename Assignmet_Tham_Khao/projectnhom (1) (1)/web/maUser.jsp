        ...
        <table>
            ...
            <% 
                ...
                try {
                    ...
                    String sql = "SELECT UserID, FullName, PhoneNumber, Username, RoleName FROM Users";
            ...
            <tr>
                ...
                <td>
                    <% if (!"Admin".equals(rs.getString("RoleName"))) { %>
                        <a href="editRole.jsp?action=grantAdmin&userID=<%= rs.getInt("UserID") %>">
                            <button class="button btn-admin">Cấp quyền Admin</button>
                        </a>
                    <% } %>
                    <a href="editRole.jsp?action=delete&userID=<%= rs.getInt("UserID") %>" 
                        onclick="return confirm('Bạn có chắc muốn xóa người dùng này không?');">
                        <button class="button btn-delete">Xóa</button>
                    </a>
                </td>
            </tr>
            <% 
